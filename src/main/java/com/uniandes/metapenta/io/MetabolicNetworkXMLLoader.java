...
import com.uniandes.metapenta.model.metabolicnetwork.*;
...
public class MetabolicNetworkXMLLoader {
	...
	public MetabolicNetwork loadNetwork (String modelName) throws IOException {
		MetabolicNetwork mn = null;

		Document doc = createDocument(modelName);
	...
	private Document createDocument(String modelName) {
		InputStream is = null;
		Document doc;

		try {
			is = biggClient.downloadModel(modelName);
